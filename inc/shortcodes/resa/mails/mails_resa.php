          ...
          <tr>
            <td>
              <table cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                  <td>
                    Nous vous confirmons votre réservation #'.$resa_id.' :
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    - '.$resa_kids.' en zone kids le '.date('d/m/Y', strtotime(fullinparkResaManager::convertDateFormat($_POST['resa_date']))).' à '.date('H:i', strtotime($_POST['resa_hour'])).' pour une durée de '.$_POST['resa_duration'].'
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td>
              <table cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                  <td>
                    Réservation confirmée de '.$_POST['resa_contact_fullname'].' '.$_POST['resa_contact_phone'].' '.$_POST['resa_contact_email'].' :
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    - '.$resa_kids.' en zone kids le le '.date('d/m/Y', strtotime(fullinparkResaManager::convertDateFormat($_POST['resa_date']))).' à '.date('H:i', strtotime($_POST['resa_hour'])).' pour une durée de '.$_POST['resa_duration'].'
                  </td>
                </tr>
              </table>
            </td>
