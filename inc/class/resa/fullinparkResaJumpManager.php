<?php
if(!class_exists('fullinparkResaJumpManager')):
  class fullinparkResaJumpManager{
    ...
    public static function jump_resa_number_by_slot($today_resa, $hour){
      ...
      foreach ($today_resa as $resa):
        if(get_post_meta($resa->ID, 'resa_activity', true) == 'Jump'):
    ...
    public static function get_jump_people_not_out($today_resa, $hour){
      $people_not_out = 0;
    ...
    public static function jump_resa_real_number_by_slot($today_resa, $hour){
      $total_real_jump = 0;
      ...
      if($is_previ1):
        return (self::jump_resa_number_by_slot($today_resa, ($hour - 1800)) + self::get_current_resa($today_resa, $hour));
      elseif($is_previ2):
        return (self::jump_resa_number_by_slot($today_resa, ($hour - 3600)) + self::get_current_resa($today_resa, ($hour - 1800)) + self::get_current_resa($today_resa, $hour));
      elseif($is_active):
        return $total_real_jump + self::get_jump_people_not_out($today_resa, $hour);
      endif;
    ...
    public static function get_kids_people_not_out($today_resa, $hour){
      $people_not_out = 0;
    ...
    public static function kids_resa_real_number_by_slot($today_resa, $hour){
      $total_real_kids = 0;
      ...
      if($is_previ1):
        return (self::kids_resa_number_by_slot($today_resa, ($hour - 1800)) + self::get_kids_current_resa($today_resa, $hour));
      elseif($is_previ2):
        return (self::kids_resa_number_by_slot($today_resa, ($hour - 3600)) + self::get_kids_current_resa($today_resa, ($hour - 1800)) + self::get_kids_current_resa($today_resa, $hour));
      elseif($is_active):
        return $total_real_kids + self::get_kids_people_not_out($today_resa, $hour);
      endif;
